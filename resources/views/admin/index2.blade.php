...
<div class="content">
  <main class="container">
    <h4>Aceptacion Estudiantes Vinculacion con la Sociedad- Aceptacion</h4>
      ...
      <table class="table table-bordered table-success">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <form action="{{ route('admin.eliminar2', ['correoElectronico' => $usuario['correoElectronico']]) }}"
                method="post">
                @csrf
                 <button type="submit" class="btn btn-danger btn-sm"
                  onclick="return confirm('¿Estás seguro de que quieres Rechazar a este usuario?')">Rechazar</button>
              </form>
              <form action="{{ route('admin.aceptar2', ['correoElectronico' => $usuario['correoElectronico']]) }}"
                method="post">
                @csrf
