...
<head>
    ...
    <title>Rechazo - Vinculación con la Sociedad</title>
    <style>
        body {
        ...
        /* Párrafos específicos de color negro */
        .black-text {
            color: #000;
        }
...
<body>
    <div class="container">
        ...
        <h1>Rechazo de Vinculación con la Sociedad</h1>
        <p class="black-text">Estimado/a {{ $usuario['nombreCompleto'] }},</p>
        <p class="black-text">Nos complace informarte que tu solicitud de vinculación con la sociedad ha sido rechazada.
            Valoramos tu
        ...
        <p class="black-text">A continuación, te proporcionamos algunos detalles sobre tu solicitud:</p>
        <ul>
        ...
        <p class="black-text">Por favor, no dudes en <a href="{{ route('register.index') }}"
                style="color: #007bff; text-decoration: underline;">Realizar un nuevo registro</a> si necesitas más
            información o si deseas discutir ideas para futuras colaboraciones.</p>

        <p class="black-text">¡Esperamos con entusiasmo trabajar juntos para hacer una diferencia positiva en nuestra
            sociedad!</p>
        <p class="black-text">Saludos cordiales,</p>
        <p class="black-text">Equipo de Vinculación con la Sociedad</p>

        <div id="reducir-img">
            <img
                src="https://ci3.googleusercontent.com/mail-sig/AIorK4z7EUv_PXmbRrZEFi4sUWPhKIGo595K0D9DrrY6_XH22qpDcSqp_aPpadwhPUgAwfuaskljR3M"
