...
class AdminController extends Controller
{
        ...
        try {
            ...
            if ($response->successful()) {
                ...
                if ($usuario) {
                    ...
                    $responseDelete = Http::delete('http://localhost:3000/eliminar-usuario', [
    ...
    public function eliminar2($correoElectronico)
    {
        try {
            ...
            if ($response->successful()) {
                ...
                if ($usuario) {
                    $responseUpdate = Http::put('http://localhost:3000/actualizar-estado', [
                        'correoElectronico' => $usuario['correoElectronico'],
                        'estado' => 'En proceso',
                    ]);
    ...
    {
        try {
            $response = Http::get('http://localhost:3000/Usuarios', ['correoElectronico' => $correoElectronico]);
